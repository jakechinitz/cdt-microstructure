...
\section{23. Closure-Status Table}
...
\section{24. Falsifiability and Observational Tests}

\subsection{24.1 Static weak-field falsifiers}
...
\subsection{24.2 Dynamical falsifiers}
...
\subsection{24.3 Cosmological falsifiers}
...
\subsection{24.4 Correlated-constant falsifiers}
...
\subsection{24.5 Many-Pasts status}
...
\section{25. What the Theory Would Have to Get Wrong to Fail}
...
\section{26. Comparison with Other Approaches}
...
\subsection{26.1 Relative to \texorpdfstring{$\Lambda$}{Lambda}CDM}
...
\subsection{26.2 Relative to MOND-like interpolation programs}
...
\subsection{26.3 Relative to Verlinde-style emergent gravity}
...
\subsection{26.4 Relative to TeVeS and other multi-field modified gravities}
...
\subsection{26.5 Relative to AeST}

The closest modern comparator is the AeST theory of Skordis and Z\l{}o\'snik \citep{Skordis2021}, which reproduces MOND-scale galaxy phenomenology and fits the CMB power spectrum using a vector field and two scalar degrees of freedom. AeST establishes that galaxy-scale modified dynamics and a viable linear cosmology can coexist in a single relativistic theory, and any framework in this space is measured against it. The present construction differs in starting point and in risk profile: the acceleration scale, the interpolation argument, and the source projections descend from a finite UV counting problem with coefficients fixed in advance, so nothing can be adjusted where AeST retains functional freedom, and the cosmological sector is correspondingly less developed --- the full Boltzmann treatment AeST has passed is named open work here (Section~24.3). The two programs fail differently: AeST through accumulating parameter pressure, the present framework through any single fixed coefficient meeting a contrary measurement.

\subsection{26.6 Relative to scalar-tensor gravity}
...
\subsection{26.7 Relative to quantum-mechanical interpretations}
